...
/*   Updated: 2025/11/12 15:45:38 by asbouani         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ray_direction(t_game *game, t_ray *ray, int x)
{
	...
	ray->ray_dx = game->player.dx + game->player.plane_x * camera_x;
	ray->ray_dy = game->player.dy + game->player.plane_y * camera_x;
}
